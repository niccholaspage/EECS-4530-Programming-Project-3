 ...
 * Modified the existing code to implement the SnowParticle class, based on Dr. Heuring's C++ version.
 * The SnowParticle code starts at the top of the screen with randomly generated X and Z values,
 * and then falls uniformly on each timestep. They start with no initial velocity.
 * Currently the SnowParticles are elephants from the obj file located at
 * src/elehantTriangles.obj, but this can be updated easily. I also cleaned up the
 * sample code a lot.
 */
...
public class Snow {
    ...
    public static class HelloTriangleSimple implements GLEventListener, KeyListener {
        ...
        private void buildObjects(GL4 gl) {
            ...
            // NOTE: Change this line to use a different object as the snowflakes.
        ...
        public void display(GLAutoDrawable drawable) {
            ...
            // Draw elephants as snow
            gl.glBindVertexArray(vertexArrayName.get(0));
            gl.glBindBuffer(GL_ARRAY_BUFFER, bufferName.get(0));
            PMVMatrix snowScale = new PMVMatrix();

            // Adjust scaling of snow with this line.
            ...
            // This adjusts the speed of the snow as it falls.
